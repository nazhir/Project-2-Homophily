...
location.map <- location.map + ggtitle("Hourly Distribution of Call Events for 100 - 300")
...
ggsave(filename="./figures/my_call_bubbles_hourly_100_300.png", width=10, height=10) #change date
