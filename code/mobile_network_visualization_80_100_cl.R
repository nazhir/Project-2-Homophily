...
filename <- "./figures/mobile_network_igraph_80_100_cluster1.pdf"
...
## For all degrees
pdf(file = "./figures/all_deg_dist_pl_80_100_cl1.pdf")
op <- par(mfrow = c(2, 1))
options(scipen = 10)
## Histogram and cumulative distribution function
hist(degrees, freq = FALSE, xlab = "Degree k",
     main = "Histogram of All Degrees On 80-100 Cluster 1", breaks = 50, col = "gray")
mainStr <- "Degree Power-law Distribution On 80-100 Cluster 1"
...
## Histogram and cumulative distribution function
hist(degrees, freq = FALSE, xlab = "Degree k",
     main = "Histogram of All Degrees On 80-100 Cluster 2", breaks = 50, col = "gray")
mainStr <- "Degree Power-law Distribution On 80-100 Cluster 2"
plot(x, cumy, log = "xy", xlab = "Degree k",
     ylab = expression(Pr(x) >= k), cex = 0.5, main = mainStr)
## Overlay the fitted distribution
startval <- cumy[pl$xmin]
