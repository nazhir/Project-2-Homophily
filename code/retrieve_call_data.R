...
## Created by Joe MIB TA
## This script to retreive the call data from mongo db
...
write.csv(call.data, file="./data/my_call_data.csv", row.names=FALSE)
